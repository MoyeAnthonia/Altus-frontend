  ...
  return (
    <>
      ...
      <main className={styles.lsMain}>
        ...
        {isLoading ? (
          <Spinner label="Loading difficulty options..." />
        ) : (
          <div className={styles.lsCards}>
            ...
            >
              ...
              <span className={styles.lsCardCount}>{easyDifficulty?.target_reps ?? 10}</span>
            ...
            >
              ...
              <span className={styles.lsCardCount}>{mediumDifficulty?.target_reps ?? 20}</span>
              <span className={styles.lsCardUnit}>Squats</span>
            ...
            >
              ...
              <span className={styles.lsCardCount}>{hardDifficulty?.target_reps ?? 40}</span>{" "}
              <span className={styles.lsCardUnit}>Squats</span>
